...
import { recordReadActivity } from '@/lib/user/activity-service'
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error('[user][activity][view][POST]', requestId, error)
    return fail(requestId, 500, 'INTERNAL_ERROR', 'Failed to record read activity.')
  }
}
