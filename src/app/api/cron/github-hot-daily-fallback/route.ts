...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    try {
      ...
      console.error('[cron][github-hot-daily-fallback][save-last-run]', requestId, saveError)
    }

    console.info('[cron][github-hot-daily-fallback]', {
      requestId,
    ...
    console.error('[cron][github-hot-daily-fallback]', requestId, error)
    return fail(requestId, 500, 'INTERNAL_ERROR', 'Failed to run github hot daily fallback cron')
  }
}
