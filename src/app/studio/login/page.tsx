...
import { StudioGitHubSignInButton } from '@/components/studio/studio-github-signin-button'
...
export default async function StudioLoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <div className='mx-auto mt-10 max-w-xl rounded-3xl border border-white/70 bg-white/60 p-8 backdrop-blur'>
      <h2 className='font-title text-4xl text-[var(--color-ink)]'>Studio 登录</h2>
      <p className='mt-3 text-sm leading-6 text-[var(--color-ink-soft)]'>登录后可配置你的模型 Key、定时主题任务，并生成待审核草稿。</p>
      ...
      <div className='mt-6 flex flex-wrap gap-3'>
        <StudioGitHubSignInButton callbackUrl={callbackUrl} />
